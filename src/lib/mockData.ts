...
export const INITIAL_LOGS: ActivityLog[] = [
  ...
  },
  {
    ...
    entityId: "prufung-a1",
    targetId: "stu-romaric",
    action: "Épreuve Prüfung : Compréhension Écrite (Lesen)",
    details: "Simulation d'examen officiel Goethe-Zertifikat A1 complétée avec succès (Score: 85%).",
    ipAddress: "105.235.12.8",
    status: "success",
  },
  {
    id: "log-audit-stu-romaric-3",
    ...
    schoolName: "Berlin Sprachzentrum",
    entityType: "ai",
    entityId: "sub-romaric-1",
    targetId: "stu-romaric",
    action: "Atelier de Rédaction IA Soumis",
    details: "Texte d'expression écrite sur 'Meine Familie und Freizeit' corrigé par le tuteur IA (Note: 92/100).",
    ipAddress: "105.235.12.8",
    status: "success",
  },
  {
    ...
    details: "Progression enregistrée sur la leçon Dire bonjour & se présenter (Score: 100% au quiz).",
    ipAddress: "105.235.12.8",
    status: "success",
  },
  {
    id: "log-audit-stu-romaric-1",
    ...
    targetId: "stu-romaric",
    action: "Session d'Apprentissage Démarrée",
    details: "Authentification réussie au portail élève. Vérification de session active et conformité du compte.",
    ipAddress: "105.235.12.8",
    status: "success",
  },
  {
